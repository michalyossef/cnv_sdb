var express = require('express'),
    ...
    fs = require('fs'),
    app = express(),
    port = process.env.PORT || 1337, //2001
...
release_db.once('open', function () {
    ...
    unrelease_db.once('open', function () {
        ...
        var cellMacro = require('./api/models/congestion/congestionModel');
        ...
        var userRoutes = require('./api/routes/congestion/congestionRoutes'); //importing route
        userRoutes(app); //register the route
